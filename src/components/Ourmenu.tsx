...
import main1 from "../../public/ro.png"
 const ourdata = [
  {
    id:0,
    title: "Lettuce Leaf",
      ...
      <div className="flex flex-col lg:flex-row px-[20px] md:px-[50px] lg:px-[100px] py-[20px] md:py-[50px] gap-[10px] md:gap-[15px] lg:gap-[20px]">
        <div className="flex justify-center items-center">
          <Image
            src={main1}
            alt="maipic"
            className="w-full max-w-[300px] md:max-w-[400px] lg:max-w-[500px] h-auto relative "
          />
          <Image
            src={main}
            alt="maipic"
            className="w-full max-w-[250px] md:max-w-[350px] lg:max-w-[350px] h-auto  absolute"
          />
        </div>
