...
const Testi = () => {
  return (
    <div className=' bg-center'style={{ backgroundImage: "url('fo.png')"}}>
    <div className="px-[20px] md:px-[50px] lg:px-[100px] mt-[50px] md:mt-[80px] lg:mt-[100px]  ">
      ...
      <div className="px-[10px] md:px-[50px] lg:px-[100px] flex flex-col items-center ">
        <div className="mt-10 bg-white rounded-lg shadow-md p-6 md:p-8 flex flex-col items-center w-full max-w-[600px] md:max-w-[700px] lg:max-w-[868px]  shadow-white">
